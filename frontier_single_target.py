"""
Efficient Frontier: VaR vs P(5-year cumulative return > TARGET)
Simpler approach: single return target instead of averaging multiple thresholds
"""
import numpy as np
import json
...
for p_idx in range(N_PORTFOLIOS):
    ...
    # Probability of beating return target (60%)
