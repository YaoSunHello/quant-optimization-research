"""
Export frontier simulation results to Excel
"""
import numpy as np
import json
import pandas as pd

print("Running frontier simulation and exporting to Excel...\n")
...
# Save to Excel
output_file = '/Users/yaosun/Desktop/Master Folder/QuantTrading/Optimization/frontier_simulation_results.xlsx'
df.to_excel(output_file, index=False)

print(f"\n✅ Saved {len(portfolios_data)} portfolios to: frontier_simulation_results.xlsx")
print(f"\nSummary Statistics:")
